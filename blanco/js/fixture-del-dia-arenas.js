...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function cargarDatosExternos() {
        ...
        const archivosJSON = [
           // '../arenas/js/ediciones/tercerFecha/femenino/5ta.json',
            //'../arenas/js/ediciones/tercerFecha/femenino/7ma.json',
            //'../arenas/js/ediciones/tercerFecha/masculino/5ta.json',
            //'../arenas/js/ediciones/tercerFecha/masculino/7ma.json',
