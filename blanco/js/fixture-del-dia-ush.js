...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function cargarDatosExternos() {
        const archivosJSON = [
            '../firstClass/js/ediciones/cuartaFecha/femenino/4ta.json',
            '../firstClass/js/ediciones/cuartaFecha/femenino/5ta.json',
           '../firstClass/js/ediciones/cuartaFecha/femenino/6ta.json',
            '../firstClass/js/ediciones/cuartaFecha/femenino/7ma.json',
            '../firstClass/js/ediciones/cuartaFecha/femenino/8va.json',
            '../firstClass/js/ediciones/cuartaFecha/masculino/4ta.json',
            '../firstClass/js/ediciones/cuartaFecha/masculino/5ta.json',
            '../firstClass/js/ediciones/cuartaFecha/masculino/6ta.json',
            '../firstClass/js/ediciones/cuartaFecha/masculino/7ma.json',
            '../firstClass/js/ediciones/cuartaFecha/masculino/8va.json'
        ];
