document.addEventListener('DOMContentLoaded', function() {
    ...
    function createAlbumElement(albumId, albumInfo, images) {
        ...
        albumEl.dataset.category = albumInfo.category || albumId;
        ...
        albumEl.innerHTML = `
            ...
            <div class="album-actions">
                <button class="view-album-btn" data-album="${albumId}">
                    Ver fotos (${images.length} imágenes)
                </button>
                ${externalLinkHTML}
            </div>
        `;
                ...
                button.addEventListener('click', (e) => {
                    ...
                    document.querySelectorAll('.album').forEach(album => {
                        if (filterValue === 'all') {
                            ...
                            album.style.display = album.dataset.category === filterValue ? 'block' : 'none';
                        }
                    });
                });
            });
